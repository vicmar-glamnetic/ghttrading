          ...
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-ink2 leading-relaxed">
                If an account with <strong className="text-ink">{email}</strong> exists, we&apos;ve sent a password reset link. Check your spam folder if you don&apos;t see it.
              </p>
              <p className="text-xs text-ink3">The link expires in 1 hour.</p>
              <Link href="/login">
            ...
            <>
              <h2 className="text-lg font-bold text-ink mb-1">Forgot your password?</h2>
              ...
              <Link href="/login" className="flex items-center justify-center gap-1.5 mt-5 text-sm text-ink3 hover:text-yellow-500 transition-colors">
