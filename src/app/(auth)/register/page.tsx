        ...
        <div className="bg-surface rounded-2xl border border-line p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {[
              ...
              <div key={field}>
                <label className="text-xs font-semibold text-ink2 uppercase tracking-wider block mb-1.5">{label}</label>
            ...
            <div>
              <label className="text-xs font-semibold text-ink2 uppercase tracking-wider block mb-1.5">Password</label>
