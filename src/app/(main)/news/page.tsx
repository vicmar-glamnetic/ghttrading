  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <span className="ml-auto text-xs text-ink3">This week&apos;s economic calendar</span>
      </div>
      ...
      <p className="text-[10px] text-ink3 text-center">
        Economic calendar from ForexFactory. Times shown in your local timezone. Updated periodically.
      </p>
    </div>
  )
}
