...
import {
  Shield, Users, GraduationCap, UserCog, Plus, Search, Trash2, X, DollarSign, Wifi, UserX, BadgeCheck,
} from 'lucide-react'
...
export default function AdminPage() {
  ...
  // and bulk-email tools live on the admin-only Tools and Email tabs.
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        {/* Journals, Courses, Email and Tools are tabs now (see AdminTabs) —
            this header keeps only the action that belongs to this screen. */}
